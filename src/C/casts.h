...
BRLCAD::Vector2D*                            CastVector2D(BrlHandle handle);
BRLCAD::Vector3D*                            CastVector3D(BrlHandle handle);
BRLCAD::VectorList*                          CastVectorList(BrlHandle handle);
BRLCAD::VectorList::DisplaySpace*            CastVectorListDisplaySpace(BrlHandle handle);
BRLCAD::VectorList::Element*                 CastVectorListElement(BrlHandle handle);
BRLCAD::VectorList::PointDraw*               CastVectorListPointDraw(BrlHandle handle);
BRLCAD::VectorList::PointSize*               CastVectorListPointSize(BrlHandle handle);
BRLCAD::VectorList::LineMove*                CastVectorListLineMove(BrlHandle handle);
BRLCAD::VectorList::LineDraw*                CastVectorListLineDraw(BrlHandle handle);
BRLCAD::VectorList::LineWidth*               CastVectorListLineWidth(BrlHandle handle);
BRLCAD::VectorList::ModelSpace*              CastVectorListModelSpace(BrlHandle handle);
BRLCAD::VectorList::PolygonStart*            CastVectorListPolygonStart(BrlHandle handle);
BRLCAD::VectorList::PolygonMove*             CastVectorListPolygonMove(BrlHandle handle);
BRLCAD::VectorList::PolygonDraw*             CastVectorListPolygonDraw(BrlHandle handle);
BRLCAD::VectorList::PolygonEnd*              CastVectorListPolygonEnd(BrlHandle handle);
BRLCAD::VectorList::PolygonVertexNormal*     CastVectorListPolygonVertexNormal(BrlHandle handle);
BRLCAD::VectorList::TriangleStart*           CastVectorListTriangleStart(BrlHandle handle);
BRLCAD::VectorList::TriangleMove*            CastVectorListTriangleMove(BrlHandle handle);
BRLCAD::VectorList::TriangleDraw*            CastVectorListTriangleDraw(BrlHandle handle);
BRLCAD::VectorList::TriangleEnd*             CastVectorListTriangleEnd(BrlHandle handle);
BRLCAD::VectorList::TriangleVertexNormal*    CastVectorListTriangleVertexNormal(BrlHandle handle);

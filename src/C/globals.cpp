...
const char* const VectorListDisplaySpaceMagic            = "VectorListDisplaySpaceMagic";
const char* const VectorListPointDrawMagic               = "VectorListPointDrawMagic";
const char* const VectorListPointSizeMagic               = "VectorListPointSizeMagic";
const char* const VectorListLineMoveMagic                = "VectorListLineMoveMagic";
const char* const VectorListLineDrawMagic                = "VectorListLineDrawMagic";
const char* const VectorListLineWidthMagic               = "VectorListLineWidthMagic";
const char* const VectorListModelSpaceMagic              = "VectorListModelSpaceMagic";
const char* const VectorListPolygonStartMagic            = "VectorListPolygonStartMagic";
const char* const VectorListPolygonMoveMagic             = "VectorListPolygonMoveMagic";
const char* const VectorListPolygonDrawMagic             = "VectorListPolygonDrawMagic";
const char* const VectorListPolygonEndMagic              = "VectorListPolygonEndMagic";
const char* const VectorListPolygonVertexNormalMagic     = "VectorListPolygonVertexNormalMagic";
const char* const VectorListTriangleStartMagic           = "VectorListTriangleStartMagic";
const char* const VectorListTriangleMoveMagic            = "VectorListTriangleMoveMagic";
const char* const VectorListTriangleDrawMagic            = "VectorListTriangleDrawMagic";
const char* const VectorListTriangleEndMagic             = "VectorListTriangleEndMagic";
const char* const VectorListTriangleVertexNormalMagic    = "VectorListTriangleVertexNormalMagic";

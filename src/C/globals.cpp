...
const char* const Vector2DMagic                          = "BRLCAD::Vector2D";
const char* const Vector3DMagic                          = "BRLCAD::Vector3D";
const char* const VectorListMagic                        = "BRLCAD::VectorList";
const char* const VectorListElementMagic                 = "BRLCAD::VectorList::Element";
const char* const VectorListDisplaySpaceMagic            = "BRLCAD::VectorList::DisplaySpace";
const char* const VectorListPointDrawMagic               = "BRLCAD::VectorList::PointDraw";
const char* const VectorListPointSizeMagic               = "BRLCAD::VectorList::PointSize";
const char* const VectorListLineMoveMagic                = "BRLCAD::VectorList::LineMove";
const char* const VectorListLineDrawMagic                = "BRLCAD::VectorList::LineDraw";
const char* const VectorListLineWidthMagic               = "BRLCAD::VectorList::LineWidth";
const char* const VectorListModelSpaceMagic              = "BRLCAD::VectorList::ModelSpace";
const char* const VectorListPolygonStartMagic            = "BRLCAD::VectorList::PolygonStart";
const char* const VectorListPolygonMoveMagic             = "BRLCAD::VectorList::PolygonMove";
const char* const VectorListPolygonDrawMagic             = "BRLCAD::VectorList::PolygonDraw";
const char* const VectorListPolygonEndMagic              = "BRLCAD::VectorList::PolygonEnd";
const char* const VectorListPolygonVertexNormalMagic     = "BRLCAD::VectorList::PolygonVertexNormal";
const char* const VectorListTriangleStartMagic           = "BRLCAD::VectorList::TriangleStart";
const char* const VectorListTriangleMoveMagic            = "BRLCAD::VectorList::TriangleMove";
const char* const VectorListTriangleDrawMagic            = "BRLCAD::VectorList::TriangleDraw";
const char* const VectorListTriangleEndMagic             = "BRLCAD::VectorList::TriangleEnd";
const char* const VectorListTriangleVertexNormalMagic    = "BRLCAD::VectorList::TriangleVertexNormal";
